...
class FlutterAudioRecorderPlayer {
  ...
  /// Creates a new FlutterAudioRecorderPlayer instance
  FlutterAudioRecorderPlayer() {
    ...
    _playbackStateSubscription = FlutterAudioRecorderPlayerPlatform.instance
    ...
    _visualizationDataSubscription = FlutterAudioRecorderPlayerPlatform.instance
  ...
  Future<void> stopPlayback() async {
    await FlutterAudioRecorderPlayerPlatform.instance.stopPlayback();
    if (!_disposed) {
  ...
  Future<void> pausePlayback() async {
    await FlutterAudioRecorderPlayerPlatform.instance.pausePlayback();
    if (!_disposed) {
      _playingSubject.add(false);
  ...
  Future<void> resumePlayback() async {
    ...
    await FlutterAudioRecorderPlayerPlatform.instance.resumePlayback();
    if (!_disposed) {
      _playingSubject.add(true);
  ...
  Future<void> seekTo(int position) async {
    try {
      ...
      await FlutterAudioRecorderPlayerPlatform.instance.seekTo(position);
    } catch (e) {
      _handleError(
  ...
  Future<void> setSpeed(double speed) async {
    try {
      ...
      await FlutterAudioRecorderPlayerPlatform.instance.setSpeed(clampedSpeed);
    } catch (e) {
      _handleError(
