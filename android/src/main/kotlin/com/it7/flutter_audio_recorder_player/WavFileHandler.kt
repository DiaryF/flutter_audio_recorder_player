...
/**
 * Handles WAV file operations including parsing, visualization data extraction, trimming, and
 * joining.
 */
        ...
        try {
            ...
            FileInputStream(file).use { fis ->
                ...
                for (i in 0 until actualSamples) {
                    ...
                    val framePosition =
                            header.headerSize + (i * framesPerSample * header.bytesPerFrame)
                        ...
                        val amplitude =
                                when (header.bitsPerSample) {
                                    8 -> {
                                        ...
                                        abs(sample - 128) *
                                                2 // Convert 0-255 to -128-127 and get absolute
                                    }
                                    16 -> {
    ...
    fun trimWavFile(inputPath: String, outputPath: String, startMs: Int, endMs: Int): Boolean {
        try {
            ...
            if (startFrame >= endFrame || startFrame < 0 || endFrame > header.frameCount) {
                Log.e(
                        TAG,
                        "Invalid trim parameters: start=$startFrame, end=$endFrame, total=${header.frameCount}"
                )
                return false
            }
            ...
            FileInputStream(inputFile).use { fis ->
                FileOutputStream(outputFile).use { fos ->
                    ...
                    outputChannel.position(40L) // Position of data size in header
                    ...
                    outputChannel.position(4L) // Position of file size in header
                    ...
                    inputChannel.position(startPosition.toLong())
